...
const dbData = {
    ...
    mainProducts : [    //메뉴바 하단의 상품목록 (최소 1개 이상 남겨두고 나머지 삭제 가능)
        {
            name : 'Apple Watch Series 9',                             //상품 제목
            info : '보다 똑똑. 보다 또렷. 보다 강력',                    //상품 설명
            text : '595,000원부터 (보상 판매 미적용)',       //가격 등의 상세정보
            ...
            imgLink : 'https://www.apple.com/kr/apple-watch-series-9/d/images/overview/os/watchos_apps__bg6o64fyygvm_medium.jpg'
        },
        {
            ...
            fontColor : '#ffffff',        
            linkColor : '#517cd1',  
            imgLink : 'https://www.apple.com/kr/apple-watch-ultra-2/d/images/overview/design/design_glory__b6ma91iz65ci_medium.jpg'
        },
        {
            name : 'Apple Watch Se',
            info : '부담 없이 빠져들다.',
            ...
            fontColor : '#222222',        
            linkColor : '#517cd1',       
            imgLink : 'https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/se-case-unselect-gallery-1-202403_FMT_WHH?wid=752&hei=720&fmt=p-jpg&qlt=80&.v=1707846660536'
        },
    ],
    subProducts : [
