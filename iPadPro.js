...
const mainCollection = document.createElement('section');
{
    ...
    dbData.mainProducts.forEach(product => {
        ...
        newLi.innerHTML += `
            <div style = "">
                <div style="display:flex; flex-direction : column; justify-content: space-between; align-items: center; width:1446px; height:816px; background-image: url(https://www.apple.com/v/ipad-pro/aq/images/overview/hero/hero_endframe__sg50vzdd6sqm_large.jpg);">
                    <div style="text-align:center;">
                        <br>
                        <h1 style="font-size:72px ; color: #f5f5f7; ">iPad Pro</h1>
                        <h1 style="font-size:72px; background: linear-gradient(to right top, #861657, #ffa69e);
                         color: transparent;
                        -webkit-background-clip: text;">불가능이란 얇다</h1>
                    </div>
                    <div style="text-align: center;">
                        <p align="center">
                            <span style="font-size: 30px; color: #f5f5f7; ">₩2,390,000부터</span>
                        </p>
                        <br><br>
            ...
            <div style='background-color:#161617; text-align:left;'>
                <br><br><br><br><br><br><br><br><br><br><br><br>
                <h1 style="font-size:72px ; color: #86868b; margin-left:-50%;">일단 핵심부터.</h1>
                <br><br><br>
                <div style="background-color: black; width:1000px; height:680px; margin: auto; border-radius: 20px;">
                    <div display:flex; flex-direction : row; justify-content: space-between;>
                        <img src='https://www.apple.com/v/ipad-pro/aq/images/overview/highlights/design__kk16tmcuw5me_large.jpg'>
                        <h1 style="font-size:51px ; color: #86868b; margin-left:;">5.1mm</h1>
                    </div>
                </div>
            <div>
            <div style="text-align:center;">
