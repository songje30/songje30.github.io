    ...
    mainProducts : [    //메뉴바 하단의 상품목록 (최소 1개 이상 남겨두고 나머지 삭제 가능)
        {
            name : 'iPad Pro',                             //상품 제목
            info : '불가능이란 얇다.',                    //상품 설명
            text : '1,499,000원부터 (보상 판매 미적용)',       //가격 등의 상세정보
            pageLink : 'iPadPro.html',                                 //상품 페이지 이동 링크주소
        ...
        },
        {
            ...
            fontColor : '#1d1d1f',        
            linkColor : '#517cd1',  
            imgLink : 'https://www.apple.com/v/ipad-air/w/images/overview/closer-look/all-colors/slide_1A__fg52jvpudo6e_medium.jpg'
        },
        {
            name : 'iPad',
            info : '쓰다. 그리다. 빠져들다.',
            ...
            fontColor : '#ffffff',        
            linkColor : '#517cd1',       
            imgLink : 'https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/ipad-mini-finish-unselect-gallery-1-202207_FMT_WHH?wid=1280&hei=720&fmt=p-jpg&qlt=95&.v=1654903884450'
        },
    ],
    subProducts : [
