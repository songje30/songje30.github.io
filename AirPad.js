...
const dbData = {
    ...
    mainProducts : [    //메뉴바 하단의 상품목록 (최소 1개 이상 남겨두고 나머지 삭제 가능)
        {
            name : 'AirPods Pro',                             //상품 제목
            info : '',                    //상품 설명
            text : '359,000원부터 (보상 판매 미적용)',       //가격 등의 상세정보
            ...
            imgLink : 'https://www.apple.com/v/airpods-pro/j/images/meta/og__eui2mpgzwyaa_overview.png'
        },
        {
            name : 'AirPods Max',
            info : '',
            ...
            fontColor : '#1d1d1f',        
            linkColor : '#517cd1',  
            imgLink : 'https://store.storeimages.cdn-apple.com/8756/as-images.apple.com/is/airpods-max-select-spacegray-202011_FV1_FMT_WHH?wid=940&hei=800&fmt=jpeg&qlt=90&.v=1604776025000'
        },
        {
            name : 'AirPods',
            info : '',
            ...
            fontColor : '#1d1d1f',        
            linkColor : '#517cd1',       
            imgLink : 'https://www.apple.com/v/airpods-3rd-generation/f/images/meta/airpods-3rd-generation__gfzix8dj5auu_og.png'
        },
    ],
    subProducts : [
